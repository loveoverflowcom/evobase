...
/// Typed API exceptions matching backend error codes
abstract class ApiException implements Exception {
  final String code;
  final String message;
  final String? field;

  ApiException({required this.code, required this.message, this.field});
  ...
  factory ApiException.fromErrorDetail(ErrorDetail detail) {
    switch (detail.code) {
      ...
      case 'FORBIDDEN':
        return ForbiddenException(message: detail.message, field: detail.field);
      case 'NOT_FOUND':
        return NotFoundException(message: detail.message, field: detail.field);
      ...
      case 'CONFLICT':
        return ConflictException(message: detail.message, field: detail.field);
      case 'INTERNAL_ERROR':
